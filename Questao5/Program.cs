...
builder.Services.AddTransient<ICreateMovimentoHandler, CreateMovimentoHandler>();
builder.Services.AddTransient<IGetContaCorrenteHandler, GetContaCorrenteHandler>();
